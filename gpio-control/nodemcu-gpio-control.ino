...
#define TOKEN "<Your Thingsboard Device Token>"

//Using GPIO5 & GPIO4 [ D1 and D2 ]
#define GPIO5 5
#define GPIO4 4
...
//Replace with your Thingsboard server either local or Thingsboard Demo
char thingsboardServer[] = "iot.example.com";
